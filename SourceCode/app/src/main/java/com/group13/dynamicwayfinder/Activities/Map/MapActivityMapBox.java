...
public class MapActivityMapBox extends AppCompatActivity {
            ...
            public void onMapReady(@NonNull MapboxMap mapboxMap) {
                mapboxMap.setStyle(Style.MAPBOX_STREETS, new Style.OnStyleLoaded() {
                    ...
                    public void onStyleLoaded(@NonNull Style style) {
                        ...
                        Intent locationComponent = new Intent(MapActivityMapBox.this, LocationComponentActivity.class);
                        MapActivityMapBox.this.startActivity(locationComponent);
                    }
                });
            }
        });
